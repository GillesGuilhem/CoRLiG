...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:choice">
        <!-- on fait apparaître dans le texte la version régularisée et corrigée, en bull grâce à l'attribut title la version originale et non corigée -->
        <span title="{tei:orig | tei:sic}">
